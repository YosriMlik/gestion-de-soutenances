...
__decorate([
    (0, typeorm_1.ManyToOne)(() => defence_entity_1.Defence, (defence) => defence.students, { onDelete: 'SET NULL' }),
    (0, typeorm_1.JoinColumn)({ name: 'defence_id' }),
    __metadata("design:type", defence_entity_1.Defence)
], Student.prototype, "defence", void 0);
